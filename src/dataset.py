...
class SentimentDataset(Dataset):
    def __init__(self, filepath):
        ...
        self.vocab = build_vocab_from_iterator(map(self.tokenizer, self.texts), specials=["<unk>"])
    ...
    def collate_batch(self, batch):
        ...
        text_list = pad_sequence(text_list, padding_value=self.vocab["<pad>"], batch_first=True)
